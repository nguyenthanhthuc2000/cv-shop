...
{{--                    <img src="{{asset('_shop/images/tc1.jpg')}}" alt="#">--}}
{{--                </div>--}}
{{--                <div class="banner-tieu-chi">--}}
{{--                    <img src="{{asset('_shop/images/tc2.jpg')}}" alt="#">--}}
{{--                </div>--}}
{{--                <div class="banner-tieu-chi">--}}
{{--                    <img src="{{asset('_shop/images/tc3.jpg')}}" alt="#">--}}
{{--                </div>--}}
{{--                <div class="banner-tieu-chi">--}}
{{--                    <img src="{{asset('_shop/images/tc4.jpg')}}" alt="#">--}}
{{--                </div>--}}
{{--                <div class="banner-tieu-chi">--}}
{{--                    <img src="{{asset('_shop/images/tc2.jpg')}}" alt="#">--}}
{{--                </div>--}}
                                            ...
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <a href="product-details.html">
                                                        <img class="default-img" src="https://via.placeholder.com/550x600" alt="#">
